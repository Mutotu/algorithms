...
// console.log(solution([2, 4, 6, 6, 3]));
...
//     if (s1.charCodeAt(pointer) < s2.charCodeAt(i)) {
//       chars += s1[pointer];
//       pointer++;
//     } else if (s1.charCodeAt(i) > s2.charCodeAt(pointer--)) {
//       chars += s2[i];
//       pointer--;
//     } else {
//       chars += s1[i];
